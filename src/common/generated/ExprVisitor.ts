...
import { IBullBearListContext } from "./ExprParser.js";
...
import { IDojiContext } from "./ExprParser.js";
...
import { Bull_bear_listContext } from "./ExprParser.js";
import { DojiContext } from "./ExprParser.js";
...
export class ExprVisitor<Result> extends AbstractParseTreeVisitor<Result> {
    ...
    /**
     * Visit a parse tree produced by the `iBullBearList`
     * labeled alternative in `ExprParser.expr`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitIBullBearList?: (ctx: IBullBearListContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by the `iDoji`
     * labeled alternative in `ExprParser.expr`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitIDoji?: (ctx: IDojiContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by `ExprParser.bull_bear_list`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitBull_bear_list?: (ctx: Bull_bear_listContext) => Result;
    /**
     * Visit a parse tree produced by `ExprParser.doji`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitDoji?: (ctx: DojiContext) => Result;
    /**
